public class Simulation {
    ...
    public final static int ABSTAND_BEOBACHTUNG = 5;    // Intervall in welchem der "Streckenwachter" updatet
    public final static int ANZ_VERSUCHE = 3;            // Versuche des Zuges weiter zu fahren, bevor er "aufgibt"
