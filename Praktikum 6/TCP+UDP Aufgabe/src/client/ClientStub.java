...
public class ClientStub implements StreckeI // Stub
{
    ...
    public Boolean reserviere(Integer zugnummer, Boolean bRichtung, Integer iAbschnitt) {
        ...
        String test = sendMsg(strNachricht);
        return (Boolean) parseResponse(strNachricht);
    }
    ...
    public String buildMsg(String action, int zugnummer, boolean bRichtung, int iAbschnitt) {
        ...
        try {
            ...
            if (!action.equals("getStreckenLaenge") && !action.equals("getAbschnitt")) {   // Zugnummer ist Parameter
            ...
            if (!action.equals("getStreckenLaenge")) {   // Richtung ist Parameter
                xtw.writeStartElement("param");
                xtw.writeStartElement("value");
            ...
            if (!action.equals("verlassen") && !action.equals("getStreckenlaenge")) {   // Abschnitt ist Parameter
                xtw.writeStartElement("param");
                xtw.writeStartElement("value");
                xtw.writeStartElement("int");
    ...
    public String sendMsg(String dieNachricht) {
        ...
        System.out.println("Connection Object:" + theConnection);
